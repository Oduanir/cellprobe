# Project history — internal design notes

> This file is the **original README** of the project, preserved for the design
> rationale, alternatives considered, and engineering trade-offs it captures.
> The public-facing project description is now in the top-level
> [`README.md`](../README.md); the headline results are in [`RESULTS.md`](../RESULTS.md).
>
> **Note**: the original plan in this document called for *end-to-end fine-tuning*
> of Geneformer. After auditing what BioNeMo 2.7.1 actually ships
> (`bionemo.geneformer.scripts.celltype_classification_bench`) the project pivoted
> to a **frozen-encoder + MLP probe** methodology, which is what NVIDIA themselves
> benchmark Geneformer with. This pivot is documented in
> [`RESULTS.md`](../RESULTS.md) (§ "Why frozen + probe instead of full fine-tuning?").
